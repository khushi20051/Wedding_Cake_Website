...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a href="index.html" class="navbar-brand">khushboo</a>
            ...
            <div class="container">
                <div class="row slider-text js-fullheight justify-content-center align-items-center"
                    ...
                    <div class="col-md-12 col-sm-12 text-center ftco-animate">
                        <span class="subheading">khushboo</span>
        ...
        <div class="slider-item js-fullheight" style="background-image: url(images/bg_3.jpg);">
            ...
            <div class="container">
                <div class="row slider-text js-fullheight justify-content-center align-items-center"
                    ...
                    <div class="col-md-12 col-sm-12 text-center ftco-animate">
                        <span class="subheading">khushboo</span>
                        <h1 class="mb-4">khushboo Special Dessert</h1>
                    </div>
        ...
        <div class="slider-item js-fullheight" style="background-image: url(images/bg_4.jpg);">
            ...
            <div class="container">
                <div class="row slider-text js-fullheight justify-content-center align-items-center"
                    ...
                    <div class="col-md-12 col-sm-12 text-center ftco-animate">
                        <span class="subheading">khushboo</span>
                        <h1 class="mb-4">khushboo Special Pastries</h1>
                    </div>
                    ...
                    <div class="col">
                        <div class="intro_content">
                            ...
                            <div class="intro_text">
                                <p>this website is make by me its khushboo you can order cake from here thank you for your kind love.</p>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    <p class="mb-4">
                                        this is one the best cake shop in my aria i love it
                                    </p>
                                    <div class="d-flex align-items-center">
                                        <div class="user-img" style="background-image: url(images/abhi.jpeg);"></div>
                                        <div class="pl-3">
                                            <p class="name">abhishek kumari</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="user-img" style="background-image: url(images/khushi.jpeg);"></div>
                                        <div class="pl-3">
                                            <p class="name">khushboo kumari</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="user-img" style="background-image: url('images/raghav.jpg');"></div>
                                        <div class="pl-3">
                                            <p class="name">raghav kumar</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="user-img" style="background-image: url(images/anchal.jpeg);"></div>
                                        <div class="pl-3">
                                            <p class="name">Anchal kumari</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="user-img" style="background-image: url(images/kalpna.jpeg);"></div>
                                        <div class="pl-3">
                                            <p class="name">kalpna kumari</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img" style="background-image: url('images/raghav.jpg');"></div>
                        <div class="text pt-4">
                            <h3>raghav kumar</h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img" style="background-image: url(images/khushi.jpeg);"></div>
                        <div class="text pt-4">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img" style="background-image: url(images/kalpna.jpeg);"></div>
                        <div class="text pt-4">
                            <h3>kalpna kumari</h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img" style="background-image: url(images/abhi.jpeg);"></div>
                        <div class="text pt-4">
                        ...
                        <form action="#" class="subscribe-form">
                            <div class="form-group">
                                <input type="text" class="form-control mb-2 text-center"
                                    placeholder="kumarikhushboo19muz@gmail.com">
